...
plt.plot(x, y, '-o', linewidth=2.5, ms=7, color=real_colors[2],
         markeredgecolor='k', markeredgewidth=0.6, label=names[2] + ' (activations)')
...
plt.plot(x, y, '--o', linewidth=2.5, ms=7, color=fake_colors[2],
         markeredgecolor='k', markeredgewidth=0.6, label=names[2]+ ' (uniform)')
...
plt.plot(x, y, '-^', linewidth=2.5, ms=7, color=real_colors[1],
         markeredgecolor='k', markeredgewidth=0.6, label=names[1] + ' (activations)')
...
plt.plot(x, y, '--^', linewidth=2.5, ms=7, color=fake_colors[1],
         markeredgecolor='k', markeredgewidth=0.6, label=names[1]+ ' (uniform)')
...
plt.plot(x, y, '-v', linewidth=2.5, ms=7, color=real_colors[0],
         markeredgecolor='k', markeredgewidth=0.6, label=names[0] + ' (activations)')
...
plt.plot(x, y, '--v', linewidth=2.5, ms=7, color=fake_colors[0],
         markeredgecolor='k', markeredgewidth=0.6, label=names[0] + ' (uniform)')


plt.title('HESE Produces Encodings with Fewer Terms')
plt.xlabel('Number of Terms Required to Represent a Value')
