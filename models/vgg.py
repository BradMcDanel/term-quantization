...
__all__ = [
    ...
    'vgg19_bn', 'vgg19', 'convert_vgg', 'convert_value_vgg',
]
...
def convert_vgg(model, w_move_terms, w_move_group, w_stat_terms, w_stat_group,
...
def convert_value_vgg(model, w_move_terms, w_move_group, w_stat_values, w_stat_group,
