...
plt.bar(x_ticks, value_reveal, label='Value Reveal', width=width, edgecolor='k', color='darkseagreen')
plt.bar(x_ticks+width, term_reveal, label='Term Reveal', width=width, hatch='/', edgecolor='k', color='tomato')
plt.bar(x_ticks+2*width, baseline_reveal, label='Baseline', width=width, hatch='//', edgecolor='k', color='grey')
